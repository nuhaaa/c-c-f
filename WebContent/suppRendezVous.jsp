...
<title>Supprier un Rendez vous </title>
</head>
<body>
	<div class="container">
		<div    class="row" >
			...
			<div class="row">
                ...
                <div class="col-lg-9 col-lg-offset-2">
                    <div class="panel-body">
                        <a href="ajoutRendezVous.jsp"><button type="button" class="btn btn-default btn-rounded waves-effect m-b-5" style="width:200px">Nouveau Rendez-Vous</button></a>
						...
						<button type="button" class="btn btn-purple btn-rounded waves-effect waves-light m-b-5" style="width:810px; height:164px"></button>
				...
				<div class="col-md-9  col-md-offset-2">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Liste des rendez vous  de <%=dos.getPatient().getPrenom() %>  <%=dos.getPatient().getNom() %></h3>
                                    </div>
                                    <div class="panel-body">
				                               ...
				                               %>
                                                        <tr>
															...
															<td><a href="suppRend.chu?id=<%=rend.getId()%>"><button type="button" class="btn btn-info btn-custom waves-effect waves-light m-b-5" style="width:250px"  >Supprimer</button></a></td>
                                                        </tr>
													<% 
														}
                                            			}
