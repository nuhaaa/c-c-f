			...
			<div class="row">
				...
				<div class="col-lg-12 ">
                    <div class="panel-body">
                        ...
                        <a href="ajoutExamenClinique.jsp"><button type="button" class="btn btn-primary btn-rounded waves-effect waves-light m-b-5" style="width:150px">Examen Clinique</button></a>
                        <a href="ajoutEndoscopie.jsp"><button type="button" class="btn btn-info btn-rounded waves-effect waves-light m-b-5" style="width:150px">Endoscopie</button></a>
                        <a href="ajoutAnaPathologie.jsp" ><button type="button" class="btn btn-warning btn-rounded waves-effect waves-light m-b-5" style="width:200px">Anatomie Pathologique</button></a>
                        <a href="ajoutImagerie.jsp"><button type="button" class="btn btn-default btn-rounded waves-effect m-b-5" style="width:100px">Imagerie</button></a>
						<a href="ajoutBiologie.jsp"><button type="button" class="btn btn-primary btn-rounded waves-effect waves-light m-b-5" style="width:100px">Biologie</button></a>
						<a href="ajoutGenetique.jsp"><button type="button" class="btn btn-info btn-rounded waves-effect waves-light m-b-5" style="width:100px">Génétique</button></a>
						<a href="ajoutTraitement.jsp"><button type="button" class="btn btn-warning btn-rounded waves-effect waves-light m-b-5" style="width:150px">Traitement</button></a>
                    </div>                       
                </div>
				<div class="row">
                        <div class="col-sm-8 col-sm-offset-2">
                        	<%
										...
										imageries = dosDAO.listerExamenImagParPatient(idPatient);
										 
									%>
                        	<div class="panel panel-default">
								<div class="panel-heading"><h3 class="panel-title">Examen radiologique de <%=patient.getPrenom()%> <%=patient.getNom() %></h3></div>
                                    <div class="panel-body">
                                        <div class="row">
                                            <div >
                                            <table class="table table-striped">
                                                    ...
                                                    <tr>
                                                    	<td>Imagerie </td>
                                                     	<td>du <%=e.getDateRadio()%></td> 
                                                     	<td><a href="suppImagerieTrait.chu?id=<%=e.getId()%>" onclick=""><button type="button" class="btn btn-info btn-custom waves-effect waves-light m-b-5" style="width:250px"  >Supprimer</button></a></td> 
