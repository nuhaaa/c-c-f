                                            ...
                                            <table class="table table-striped">
                                                    ...
                                                    <tr>
                                                    	<td>Examen endoscopique</td>
                                                     	...
                                                     	<td><a href="modEndoscopieNormal.chu?id=<%=e.getId()%>" onclick=""><button type="button" class="btn btn-info btn-custom waves-effect waves-light m-b-5" style="width:250px"  >Modifier</button></a></td> 
