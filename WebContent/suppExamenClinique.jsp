                                            ...
                                            <table class="table table-striped">
                                                    ...
                                                    <tr>
                                                    	<td>Examen clinique</td>
                                                     	<td>du <%=e.getDateExamen()%></td> 
                                                     	<td><a href="suppExamenCliniqueTraitNormal.chu?id=<%=e.getId()%>" onclick=""><button type="button" class="btn btn-info btn-custom waves-effect waves-light m-b-5" style="width:250px"  >Supprimer</button></a></td> 
                                        ...
                                        <div class="row">
                                            ...
                                            <table class="table table-striped">
                                                    ...
                                                    <tr>
                                                    	<td>Examen clinique</td>
                                                     	<td>du <%=e.getDateExamen()%></td> 
                                                     	<td><a href="suppExamenCliniqueTraitPost.chu?id=<%=e.getId()%>" onclick=""><button type="button" class="btn btn-info btn-custom waves-effect waves-light m-b-5" style="width:250px"  >Supprimer</button></a></td> 
