					...
					<div class="panel-body">
						<a href="statut.jsp"><button type="button"
							...
							href="Imagerie.jsp"><button type="button"
								...
								type="button"
								class="btn btn-default btn-rounded waves-effect m-b-5"
								style="width: 100px">G�n�tique</button></a> <a
							href="Traitement.jsp"><button type="button"
								class="btn btn-default btn-rounded waves-effect m-b-5"
								style="width: 150px">Traitement</button></a>
					</div>
				</div>
				<form class="form-horizontal" role="form" action="ajoutAnapath.chu"
						...
						<div class="col-sm-8 col-sm-offset-2">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h3 class="panel-title">Anatomie Pathologique</h3>
								</div>
								<div class="panel-body">
									<%
									...
									<div class="form-group">
										<label class="col-sm-4 form-control-label">Type de
											prvement:</label>
										<div class="col-sm-8">
											<%
									...
									<div class="form-group">
										<label for="" class="col-sm-4 form-control-label">Ref
					...
					<div class="row">
						<div class="col-md-6 ">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h3 class="panel-title">Tumeur</h3>
								</div>
								<div class="panel-body">
									<div class="form-group">
										...
										%>
										<div class="col-sm-8">
											<select class="form-control" name="siegeTumeur"
												style="width: 250px">
												<%
									...
									<div class="form-group">
										<label class="col-sm-4 form-control-label">Type
											Hystologique:</label>
										<%
									...
									<div class="form-group">
										...
										%>
										<div class="col-sm-8">
											<select class="form-control" name="diffTumeur"
												style="width: 250px">
												<%
									...
									<div class="form-group">
										...
										%>
										<div class="col-sm-8">
											<select class="form-control" name="stroma"
												style="width: 250px">
												<%
									...
									<div class="form-group">
										<label for="" class="col-sm-4 form-control-label">Le
									...
									<div class="form-group">
										...
										<div
											...
											<input id="syndrome" type="checkbox" name="engaiPeri"
												value=""> <label for="syndrome"> Engainement
												p�rinerveux </label> </br>
											</br>

										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-4 form-control-label">Limite
									...
									<div class="form-group">
										<label class="col-sm-4 form-control-label">Niveau
											d'invasion:</label>
										<div class="col-sm-8">
									...
									<div class="form-group">
										<label for="" class="col-sm-4 form-control-label">Ganglions
											m�tastatique</label> <input type="text" class="form-control"
											name="ganglions" id="" placeholder="...../....."
											style="width: 250px">
									</div>
									<div class="form-group">
										<label for="" class="col-sm-4 form-control-label">Effraction
									...
									<div class="form-group">
										<label for="" class="col-sm-4 form-control-label">L�sions
											associ�es</label> </br>
										</br>
										<div class="form-group">
											...
											<div class="form-group">
												<label class="col-sm-3  col-sm-offset-1 form-control-label">Type
													Hystologique:</label>
												<div class="col-sm-8">
													<select class="form-control" name="typeHystoPolypeLesion"
														style="width: 250px">
														<%
															for (TypeHystologique typeHyst : hystos) {
														%>
										...
										<div class="form-group">
											...
											</br> <label for="" class="col-sm-4 form-control-label">Tumeur
												Synchrome</label> </br>
											</br>
											<div class="form-group">
												<label class="col-sm-3 col-sm-offset-1 form-control-label">Type
										...
										<div class="form-group">
											<label for="" class="col-sm-4 form-control-label">Autre
												m�tastatique</label> <input type="text" class="form-control"
												name="autre" id="" placeholder="autre" style="width: 250px">
										</div>
									</div>
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="nbre" id="nbre"
											placeholder="" style="width: 250px">
									</div>
									<div class="form-group">
										<label class="col-sm-4 form-control-label">Siege:</label>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											...
											%>
											<select class="form-control" name="dysplasie"
												style="width: 250px">
												<%
									...
									<div class="form-group">
										<label class="col-sm-4 form-control-label">Limites de
