			...
			<div class="row">
                ...
                <div class="pull-left col-lg-1">
                     ...
                     <div class="panel-body">
                        <a href="espaceInfirmier.jsp"><button type="button" class="btn btn-default btn-rounded waves-effect m-b-5" style="width:250px" >Gestion Des Familles</button></a>
				...
				<div class="col-md-6 col-md-offset-2">
                                <div class="panel panel-default">
									<form  role="form" action="ajoutRendezVous.chu" method="post">
										<div class="panel-heading"><h3 class="panel-title">Nouvel Rendez-Vous</h3></div>
										<div class="panel-body">
										<%
                                    ...
                                    <div class="form-group">
                                         <input type="hidden" class="form-control" name="patient" value="<%=dos.getPatient().getId()%>"  style="width:250px">
											...
											<div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="objet" id="objet" placeholder="Entrer l'objet du rendez-vous" style="width:250px" required>
                                            </div>
											</br>
											<div class="form-group">
												<label  for="dateRendez">Date de rendez-vous</label>
												<input type="text" name="dateRendez" placeholder="jj/mm/aaaa" class="form-control" id="dateRendez" style="width:250px" required>
											</div>
											</br>
											<div class="form-group">
												<label  for="dateRendez">Heure de rendez-vous</label>
												<input type="time" name="heure"  class="form-control" id="heure" style="width:250px"placeholder="00:00:00" required>
											</div>
                                            </br></br>
											<div class="form-group">
