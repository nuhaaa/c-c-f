		...
		<div    class="row" >
			...
			<div class="row">
                ...
                <div class="col-lg-9 col-lg-offset-2">
                     <div class="panel-body">
						<button type="button" class="btn btn-purple btn-rounded waves-effect waves-light m-b-5" style="width:770px; height:200px">Gestion des Rendez-vous</button>
                    </div>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="panel panel-default">
                                    ...
                                    <div class="panel-body ">
                                        <form class="form-horizontal" role="form" action="rechercheDossierRendez.chu" method="post">
                                            <div class="form-group">
														<label class="col-sm-4 form-control-label">Recherche par Date</label> 
														<div class="col-sm-9">
                                                 			 <input type="text" name="date" placeholder="jj/mm/aaaa" class="form-control" id="date" style="width:250px">
                                                		</div>
													</div>
                                        ...
                                        <div class="row">
                                            ...
                                            <table class="table table-striped">
                                        		...
                                        		%>
                                                     ...
                                                     <tbody> 
                                                    <tr>
                                                    	<td><%=d.getPatient().getPrenom() %></td>
                                                     	<td><%=d.getPatient().getNom() %></td> 
                                                     	<td><%=d.getDateCreation() %></td> 
