				...
				<div class="row">
                        <div class="col-sm-8 col-sm-offset-2">
                        	...
                        	<div class="panel panel-default">
								<div class="panel-heading"><h3 class="panel-title">Examens Endoscopiques de <%=patient.getPrenom()%> <%=patient.getNom() %></h3></div>
                                    <div class="panel-body">
                                        <div class="row">
                                            <div >
                                            <table class="table table-striped">
                                                    ...
                                                    <tr>
                                                    	<td>Examen endoscopique</td>
                                                     	<td>du <%=e.getDateEndo()%></td> 
                                                     	<td><a href="suppEndoscopieTraitNormal.chu?id=<%=e.getId()%>" onclick=""><button type="button" class="btn btn-info btn-custom waves-effect waves-light m-b-5" style="width:250px"  >Supprimer</button></a></td> 
