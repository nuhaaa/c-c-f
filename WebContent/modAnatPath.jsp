                                            ...
                                            <table class="table table-striped">
                                                    ...
                                                    <tr>
                                                    	<td>Tumeur </td>
                                                     	...
                                                     	<td><a href="modTumeur.chu?id=<%=e.getId()%>" onclick=""><button type="button" class="btn btn-info btn-custom waves-effect waves-light m-b-5" style="width:250px"  >Modifier</button></a></td> 
                                        ...
                                        <div class="row">
                                            ...
                                            <table class="table table-striped">
                                                    ...
                                                    <tr>
                                                    	<td>Polype</td>
                                                     	<td>du <%=e.getDatePrel()%></td> 
                                                     	<td><a href="modPolype.chu?id=<%=e.getId()%>" onclick=""><button type="button" class="btn btn-info btn-custom waves-effect waves-light m-b-5" style="width:250px"  >Modifier</button></a></td> 
