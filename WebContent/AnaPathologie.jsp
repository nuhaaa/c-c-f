				...
				<%
                        ...
                        <div class="col-sm-10 col-sm-offset-1">
							 ...
							 <div class="panel-actions">
                        			<button type="button" class="btn btn-info btn-sm pull-right" onclick="location.href='ajoutAnaPathologie.jsp?id=<%=dos.getPatient().getId()%>'" >Ajouter</button>
                    			</div></br></br>
                    ...
                    <div class="panel-body">
                        <a href="ajoutAnaPathologie.jsp?id=<%=dos.getPatient().getId()%>"><button type="button" class="btn btn-primary btn-rounded waves-effect waves-light m-b-5" style="width:150px">ajouter</button></a>
                         <a href="modAnatPath.chu?id=<%=dos.getPatient().getId()%>"><button type="button" class="btn btn-primary btn-rounded waves-effect waves-light m-b-5" style="width:150px">Modifier</button></a>
