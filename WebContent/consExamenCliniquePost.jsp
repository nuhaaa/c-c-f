			...
			<div class="row">
				...
				<div class="col-lg-12 ">
                    <div class="panel-body">
						...
						<a href="Biologie.jsp"><button type="button" class="btn btn-primary btn-rounded waves-effect waves-light m-b-5" style="width:100px">Biologie</button></a>
                        ...
                        <div class="col-sm-6 col-sm-offset-3">
                        	...
                        	<div class="panel panel-default">
								...
								<table border =1>
									...
									<tr><td>Delai</td><td><%=examen.getDelai() %></td></tr>
									<tr><td>Nombres  de selles</td><td><%=examen.getNbreSelles() %></td></tr>
								</table>
