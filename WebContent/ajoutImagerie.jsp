					...
					<div class="col-sm-12">
						<div class="panel panel-default">
							...
							<form class="form-horizontal" role="form"
								enctype='multipart/form-data' action="ajoutImagerie.chu"
								method="post">
								<div class="row">
										...
										<div class="panel-body">
											...
											<div class="form-group">
												<label for="dateexamen" class="col-sm-4 form-control-label">Date
													...
													class="form-control" id="dateexamen" style="width: 250px"
													required>

											</div>
											<div class="form-group">
												<label for="poids" class="col-sm-2 form-control-label">Fichier</label>
