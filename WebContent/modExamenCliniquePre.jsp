				...
				<div class="row">
                        <div class="col-sm-12">
                        	...
                        	<div class="panel panel-default">
								...
								<form class="form-horizontal" role="form" action="modExamenCliniquePreTrait.chu" method="post">
                                    <div class="row">
										...
										<div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text" name="dateexamen" placeholder="<%=dateFormatee %>" class="form-control" id="dateexamen" style="width:250px" required>
                                                </div>
                                            </div> 
											<div class="form-group">
                                                <label for="poids" class="col-sm-2 form-control-label" >poids</label>
                                                <input type="text" class="form-control" name="poids" id="poids" placeholder="<%=examen.getPoids() %>"  style="width:250px" required >
                                            </div>
											<div class="form-group">
                                                <label for="taille" class="col-sm-2 form-control-label">Taille</label>
                                                <input type="text" class="form-control" name="taille" id="taille" placeholder="<%=examen.getTaille() %>"  style="width:250px" required>
                                            </div>
											<div class="form-group">
                                                <label for="oms" class="col-sm-2 form-control-label" >OMS</label>
                                                <input type="text" class="form-control" name="oms" id="oms" placeholder="<%=examen.getOMS() %>"  style="width:250px" required>
                                            </div>
											<div class="form-group">
                                                <label for="imc" class="col-sm-2 form-control-label">IMC</label>
                                                <input type="text" class="form-control" name="imc" id="imc" placeholder="<%=examen.getIMC() %>"  style="width:250px" required >
                                            </div>			
										</div>
										</div>
									<div class="row">
										...
										<div class="form-bottom">
											...
											<div class="panel-body">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="delai"  placeholder="le delai"  style="width:250px" >
												</div>
												<div class="form-group">
													<label for="nbSelle" class="col-sm-4  form-control-label">Nombre de Selles</label>
													<input type="text" class="form-control" name="nbSelle" id="nbSelle"   style="width:250px" >
												</div>
												<div class="form-group">
