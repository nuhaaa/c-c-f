			...
			<div class="row">
				...
				<div class="col-md-10 col-md-offset-1">
							...
							<div class="panel-actions">
                        			<button type="button" class="btn btn-info btn-sm pull-right" onclik="location.href='ajoutStatut.jsp'" >Ajouter</button>
                    			</div></br></br>
                                            ...
                                            <table class="table table-striped">
                                                    ...
                                                    <tr>
                                                    	<td>Examen endoscopique</td>
                                                     	...
                                                     	<td><a href="consEndoscopieNormal.chu?id=<%=e.getId()%>" onclick=""><button type="button" class="btn btn-info btn-custom waves-effect waves-light m-b-5" style="width:250px"  >Consulter</button></a></td> 
                    ...
                    <div class="panel-body">
                       <a href="ajoutEndoscopie.chu?id=<%=dos.getId()%>"><button type="button" class="btn btn-info btn-rounded waves-effect waves-light m-b-5" style="width:150px">Ajouter</button></a> <a href="modEndoscopie.chu?id=<%=dos.getPatient().getId()%>"><button type="button" class="btn btn-info btn-rounded waves-effect waves-light m-b-5" style="width:150px">Modifier</button></a>
