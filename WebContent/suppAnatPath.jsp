                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            ...
                                            <table class="table table-striped">
                                                    ...
                                                    <tr>
                                                    	<td>Tumeur </td>
                                                     	<td>du <%=e.getDatePrel()%></td> 
                                                     	<td><a href="suppTumeurTrait.chu?id=<%=e.getId()%>" onclick=""><button type="button" class="btn btn-info btn-custom waves-effect waves-light m-b-5" style="width:250px"  >Supprimer</button></a></td> 
                                        ...
                                        <div class="row">
                                            ...
                                            <table class="table table-striped">
                                                    ...
                                                    <tr>
                                                    	<td>Polype</td>
                                                     	<td>du <%=e.getDatePrel()%></td> 
                                                     	<td><a href="suppPolypeTrait.chu?id=<%=e.getId()%>" onclick=""><button type="button" class="btn btn-info btn-custom waves-effect waves-light m-b-5" style="width:250px"  >Supprimer</button></a></td> 
